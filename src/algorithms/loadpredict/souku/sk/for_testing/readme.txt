...
2. Installing the sk Package

A. Change to the directory that contains the file setup.py and the subdirectory sk. If 
...
The sk package is on your Python path. To import it into a Python script or session, 
execute:
