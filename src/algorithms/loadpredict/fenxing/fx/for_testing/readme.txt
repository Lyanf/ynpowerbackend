...
2. Installing the fx Package

A. Change to the directory that contains the file setup.py and the subdirectory fx. If 
...
3. Using the fx Package

The fx package is on your Python path. To import it into a Python script or session, 
execute:
