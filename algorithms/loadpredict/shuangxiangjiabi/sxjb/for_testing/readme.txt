...
2. Installing the sxjb Package

A. Change to the directory that contains the file setup.py and the subdirectory sxjb. If 
...
3. Using the sxjb Package

The sxjb package is on your Python path. To import it into a Python script or session, 
execute:
