...
2. Installing the zsph Package

A. Change to the directory that contains the file setup.py and the subdirectory zsph. If 
...
3. Using the zsph Package

The zsph package is on your Python path. To import it into a Python script or session, 
execute:
